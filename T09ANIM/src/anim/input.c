...
}/* End of 'PL6_AnimKeyboardInit' function */

/* Keyboard inter frame events handle function.
 * ARGUMENTS: None
 * RETURNS: None.
 */
static VOID PL6_AnimKeyboardResponse( VOID )
{
  ...
  memcpy(KeysOld, PL6_Anim.Keys, 256);
}/* End of 'PL6_AnimKeyboardResponse' function */
...
static VOID PL6_AnimMouseInit( VOID )
{
  ...
  PL6_Anim.Mx = pt.x;
  PL6_Anim.My = pt.y;
} /* End of 'PL6_AnimMouseInit' function */

/* Mouse inter frame events handle function.
 * ARGUMENTS: None
 * RETURNS: None.
 */
static VOID PL6_AnimMouseResponse( VOID )
{
  ...
  PL6_MouseWheel = 0;
}/* End of 'PL6_AnimMouseResponse' function */

/* Joystick inter frame events handle function.
 * ARGUMENTS: None
 * RETURNS: None.
 */
...
} /* End of 'PL6_AnimJoystickResponse' function */
...
static VOID PL6_AnimJoystickInit( VOID )
{
  ...
  for (i = 0; i < 32; i++)
    PL6_Anim.JBut[i] = 0;
} /* End of 'PL6_AnimJoystickInit' function */
...
} /* End of 'PL6_AnimInputInit' function */
...
VOID PL6_AnimInputResponse( VOID )
{
  ...
  PL6_AnimJoystickResponse();
}/* End of 'PL6_AnimInputResponse' function */
